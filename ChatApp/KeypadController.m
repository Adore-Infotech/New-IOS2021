...
-(void)viewWillAppear:(BOOL)animated {
    ...
    UIBarButtonItem *flipButton = [[UIBarButtonItem alloc]
                                   initWithTitle:@"Recent"
                                   style:UIBarButtonItemStylePlain
                                   target:self
                                   action:@selector(RecentPressed:)];

    self.tabBarController.navigationItem.leftBarButtonItem = flipButton;
...
-(IBAction)addContacts:(id)sender
{
    ...
    CNPhoneNumber * number  = [[CNPhoneNumber alloc] initWithStringValue:@""];
...
-(IBAction)RecentPressed:(id)sender {
    ...
    [self performSegueWithIdentifier:@"showRecent" sender:self];
