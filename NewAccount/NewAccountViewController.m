...
-(void)BalanceTransfer{
    ...
    UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:@"Transfer" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
...
-(void)VoucherRecharge{
    ...
    UIAlertAction *confirmAction = [UIAlertAction actionWithTitle:@"Recharge" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
