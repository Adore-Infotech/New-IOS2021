...
//    }
    ...
    NSString *PhoneNOs = [AllPhoneNos componentsJoinedByString:@","];
...
//                }
                ...
                NSScanner *scanner = [NSScanner scannerWithString: PhoneNo];
                ...
                [contactList addObject:numberString];
            }
        }
    }
...
//                }
                ...
                for (CFIndex j = 0; j < ABMultiValueGetCount(multi); j++) {
                    ...
                    if ([searchnumber containsString: phone]) {
